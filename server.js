...
const bot = new TelegramBot(token, {polling: true});
 ...
 bot.sendMessage(msg.chat.id, "Hola, Gracias, Hola Josemi, Córtate, córtate, Is that allowed?, Shut up, Hurricane Katrina, A quién le estás diciendo shut up, Chillin in the hot tub, Pussy, Hostión, I love u bitch, Fuck off, Thanks, I'm calling the police, Step the fuck up, I won't hesitate bitch");    
 });
...
bot.onText(/\Step the fuck up/, (msg) => {
